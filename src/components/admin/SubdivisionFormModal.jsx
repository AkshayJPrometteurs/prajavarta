                            ...
                            <Dialog.Panel className="w-full max-w-lg transform rounded-lg bg-white p-6 shadow-xl transition-all">
                                <div className="mb-6 flex items-center justify-between">
                                    <Dialog.Title className="text-2xl font-bold text-slate-900">
                                        {subdivision ? 'Edit Subdivision' : 'Add Subdivision'}
                                    </Dialog.Title>
                                    ...
                                    {({ values, setFieldValue, isSubmitting }) => (
                                        <Form className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <select value={values.districtId} onChange={(e) => setFieldValue('districtId', e.target.value)} className="mt-1 w-full rounded-lg border text-black border-slate-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                                            ...
                                            <div className="flex items-center gap-3 pt-2">
                                                <input type="checkbox" id="subdivisionIsActive" checked={values.isActive} onChange={(e) => setFieldValue('isActive', e.target.checked)} className="h-4 w-4 rounded border-slate-300 text-pink-600 cursor-pointer" />
                                                <label htmlFor="subdivisionIsActive" className="text-sm font-medium text-slate-700 cursor-pointer">Active</label>
                                            </div>
