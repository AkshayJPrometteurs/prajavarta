                    ...
                    <div className="flex items-center gap-2">
                        {state.categories.length > 0 && (
                            <ExportToExcel
                                ...
                                fetchUrl={`/api/admin/categories?${new URLSearchParams({ ...(debouncedSearchTerm && { search: debouncedSearchTerm }), ...(state.filterStatus !== 'all' && { isActive: state.filterStatus === 'active' }), limit: '100000' })}`}
                                headers={[{ label: 'Name', key: 'name' }, { label: 'NameEnglish', key: 'nameEnglish' }, { label: 'SortOrder', key: 'sortOrder' }, { label: 'IsActive', key: 'isActive' }]}
