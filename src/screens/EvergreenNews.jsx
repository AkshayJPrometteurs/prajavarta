...
const EvergreenNews = () => {
    ...
    const fetchData = async (page = 1) => {
        try {
            setLoading(true);
            const response = await axiosInstance.get('/news/evergreen', {
    ...
    return (
        <MainLayout isBannerAdvertisement>
            <div className="mb-8">
                <CategoryUnderline
                    name="Evergreen"
                    label={categoryName ? `${categoryName} - विशेष वाचा` : "विशेष वाचा (Evergreen)"}
                />
                <p className="text-gray-600 mt-2">
                    काळाच्या ओघातही तितक्याच महत्त्वाच्या असणाऱ्या आणि नेहमीच वाचल्या जाणाऱ्या विशेष बातम्या.
                </p>
            </div>
...
export default memo(EvergreenNews);
